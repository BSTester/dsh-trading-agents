...
模块划分：
  ...
  futu_openapi  富途 OpenAPI（REST）客户端（OAuth 2.1+PKCE / AppKey 签名，WP8）
...
导入方式：
  ...
  from trading_datasource.futu_openapi import OpenApiClient, OpenApiError
...
"""
__all__ = ["backtest", "futu_mcp", "futu_openapi", "locate", "market"]
